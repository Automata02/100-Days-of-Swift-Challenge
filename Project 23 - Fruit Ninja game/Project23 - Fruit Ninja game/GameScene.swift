//
//  GameScene.swift
//  Project23 - Fruit Ninja game
//
//  Created by Roberts Kursitis on 17/06/2022.
//
...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        sequence = [.oneNoBomb, .oneNoBomb, .twoWithOneBomb, .two, .three, .one, .chain]
        
        for _ in 0...1000 {
            if let nextSeqence = SequenceType.allCases.randomElement() {
                sequence.append(nextSeqence)
            }
        }
    ...
    func createSlices() {
        ...
        activeSliceBG.lineCap = CGLineCap(rawValue: 1)!
        
        activeSliceFG.strokeColor = UIColor.white
        activeSliceFG.lineWidth = 5
        activeSliceFG.lineCap = CGLineCap(rawValue: 1)!
